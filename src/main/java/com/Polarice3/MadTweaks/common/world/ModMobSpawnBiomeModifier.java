...
public class ModMobSpawnBiomeModifier implements BiomeModifier {
    private static final RegistryObject<Codec<? extends BiomeModifier>> SERIALIZER = RegistryObject.create(new ResourceLocation(MadTweaks.MOD_ID, "mob_spawns"), ForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, MadTweaks.MOD_ID);
